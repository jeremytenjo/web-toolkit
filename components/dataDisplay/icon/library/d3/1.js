    ...
    <svg preserveAspectRatio='xMinYMin meet' viewBox='0 0 256 243'>
      <defs>
        <linearGradient id='a' x1='-82.637%' x2='103.767%' y1='-92.82%' y2='106.042%'>
          ...
          <stop offset='100%' stopColor='#F7974E'></stop>
        </linearGradient>
        <linearGradient id='b' x1='-258.924%' x2='97.62%' y1='-248.97%' y2='98.768%'>
          <stop offset='0%' stopColor='#F9A03C'></stop>
          <stop offset='100%' stopColor='#F7974E'></stop>
        </linearGradient>
        <linearGradient id='c' x1='-223.163%' x2='94.028%' y1='-261.968%' y2='101.691%'>
          <stop offset='0%' stopColor='#F9A03C'></stop>
          <stop offset='100%' stopColor='#F7974E'></stop>
        </linearGradient>
        <linearGradient id='d' x1='11.339%' x2='82.496%' y1='-1.822%' y2='92.107%'>
          <stop offset='0%' stopColor='#F26D58'></stop>
          <stop offset='100%' stopColor='#F9A03C'></stop>
        </linearGradient>
        <linearGradient id='e' x1='15.844%' x2='120.126%' y1='3.858%' y2='72.38%'>
          <stop offset='0%' stopColor='#B84E51'></stop>
          <stop offset='100%' stopColor='#F68E48'></stop>
        </linearGradient>
        <linearGradient id='f' x1='46.984%' x2='51.881%' y1='23.466%' y2='147.391%'>
          <stop offset='0%' stopColor='#F9A03C'></stop>
          <stop offset='100%' stopColor='#F7974E'></stop>
        </linearGradient>
      </defs>
      ...
      <path
        fill='url(#f)'
        d='M176.765 242.016H95.808c16.296-10.064 30.384-23.35 41.443-38.928l39.514 38.928zm-54.453-53.645l-39.16-38.59c-10.819 23.251-34.395 39.422-61.685 39.422H0v53.208h21.467c42.01 0 79.09-21.488 100.845-54.04z'
      ></path>
    </svg>
  )
}
